...
%><%@ page session="false" contentType="text/html" pageEncoding="utf-8"
    ...
    values.put("granite:class", "field-path-picker");
    values.put("fieldLabel",   i18n.get("Schema Path (For JSON UI & Validation)"));
	values.put("value",        cfg.get("schemapath", ""));
    values.put("name",        "./content/items/" + resource.getName() + "/schemapath");
	values.put("rootPath",        "/content/dam");
